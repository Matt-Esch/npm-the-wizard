...
~~~sh
# getting the code
git clone git@github.com:nko4/team-mad-science.git && cd ./team-mad-science/

# developing
npm install
npm start

# deploying (to http://team-mad-science.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@team-mad-science.2013.nodeknockout.com
ssh root@team-mad-science.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@team-mad-science.2013.nodeknockout.com
ssh -i ./id_deploy root@team-mad-science.2013.nodeknockout.com
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/team-mad-science" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
